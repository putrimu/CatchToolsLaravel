...
<head>
    ...
    <title>Home | CatchTools Rent</title>
...
<body>
                    ...
                    <div class="col-sm-6">
                        <div class="contactinfo">
                            <ul class="nav nav-pills">
                                ...
                                <li><a href="#"><i class="fa fa-envelope"></i> admin@catchtoolsrent.com</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <div id="slider-carousel" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                <div class="col-sm-6">
                                    <h1><span>CathTools</span> Rent</h1>
                                    <h2>Cari Barang, Sewa dan Praktis </h2>
                                    <p>Rental Terbesar Yang Menyediakan Bernagai Macam Keperluan Untuk Disewakan. </p>
                                    <button type="button" class="btn btn-default get">Get it now</button>
                                </div>
                                <div class="col-sm-6">
                                    <img src="{{URL::to('frontend/images/home/girl1.jpg')}}" class="girl img-responsive" alt="" />
                                    <im g src="{{URL::to('frontend/images/home/pricing.png')}}"  class="pricing" alt="" />
                                </div>
                            </div>
                            <div class="item">
                                <div class="col-sm-6">
                                    <h1><span>CatchTools</span> Rent</h1>
                                    <h2>Terlengkap</h2>
                                    <p>Butuh Barang? Tapi keuangan menipis? CatchTools aja! </p>
                                    <button type="button" class="btn btn-default get">Get it now</button>
                                </div>
                                <div class="col-sm-6">
    ...
    <footer id="footer"><!--Footer-->
                ...
                <div class="row">
                    <div class="col-sm-2">
                        <div class="companyinfo">
                            <h2><span>CatchTools</span> Rent</h2>
                            ...
                            <div class="video-gallery text-center">
                                <a href="#">
                                    <div class="iframe-img">
                                        <img src="{{URL::to('froSntend/images/home/iframe1.png')}}" alt="" />
                                    </div>
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="row">
                    <p class="pull-left">Copyright © 2013 CatchTools Rent Inc. All rights reserved.</p>
    ...
    <script src="{{asset('frontend/js/jquery.j')}}s"></script>
